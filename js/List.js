class List extends Menu{
    ...
    // menu_save_process
    menu_save_process(){
        let list = Menu.now_menu.list;
        let cate = Menu.menu_cate_list;
        ...
        Menu.menu_list[name] = {"list":list,"cate":cate,"name":name};
        Menu.system.popup_close();
        Menu.now_menu.name = name;
